...
local andyoudiditatmybirthdaydinner = {
    ...
    ["DWP - Admin Panel Auto Execute"] = "https://github.com/uekiyas/Roblox/raw/refs/heads/main/PrayPermitTheAutomaticExecutionOfTheMostEsteemedDandysWorldPlusAdministrativePanel.lua",
}

if andyoudiditatmybirthdaydinner[ohmygodtimeandplace] then
    loadstring(game:HttpGet(andyoudiditatmybirthdaydinner[ohmygodtimeandplace]))()
end
